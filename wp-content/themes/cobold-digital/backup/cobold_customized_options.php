...
function fusionspan_custom_customizer($wp_customize){
    ...
    //  ===================================
    $wp_customize->add_setting('headquarters_heading', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('headquarters_heading', array(
        //'type' => 'number',
        'priority' => 10,
        'label'      => __('Headquarters Heading', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    //  ===================================
    $wp_customize->add_setting('headquarters_address', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('headquarters_address', array(
        'type' => 'textarea',
        'priority' => 10,
        'label'      => __('Headquarters Address', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    //  =Contact Information Text Input 2 =
    //  ===================================
    $wp_customize->add_setting('global_heading', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('global_heading', array(
        //'type' => 'number',
        'priority' => 10,
        'label'      => __('Global Development Center Heading', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    //  =Contact Information Text Input 3 =
    //  ===================================
    $wp_customize->add_setting('global_address', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('global_address', array(
        'type' => 'textarea',
        'priority' => 10,
        'label'      => __('Global Development Center Address', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    //  =Contact Information Text Input 3 =
    //  ===================================
    $wp_customize->add_setting('global_address2', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('global_address2', array(
        'type' => 'textarea',
        'priority' => 10,
        'label'      => __('Global Development Center Address 2', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    //  = Footer Copy rights =
    //  ===================================
    $wp_customize->add_setting('copy_rights_text', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control('copy_rights_text', array(
        'type'     => 'textarea',
        'priority' => 10,
        'label'      => __('Copy Rights Text', 'twentytwenty'),
        'section'    => 'contact_information',
    ));
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload', array(
        'label'    => __('Footer Bottom Logo', 'twentytwenty'),
        'section'  => 'contact_information',
    )));

    // Footer Bottom Image 2
    $wp_customize->add_setting('footer_image_upload2', array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload2', array(
        'label'    => __('Footer Bottom Logo 2', 'twentytwenty'),
        'section'  => 'contact_information',
    )));

    // Footer Bottom Image 3
    $wp_customize->add_setting('footer_image_upload3', array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload3', array(
        'label'    => __('Footer Bottom Logo 3', 'twentytwenty'),
        'section'  => 'contact_information',
    )));
	
	// Footer Bottom Image 4
    $wp_customize->add_setting('footer_image_upload4', array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload4', array(
        'label'    => __('Footer Bottom Logo 4', 'twentytwenty'),
        'section'  => 'contact_information',
    )));

    // Footer Bottom Image 5
    $wp_customize->add_setting('footer_image_upload5', array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload5', array(
        'label'    => __('Footer Bottom Logo 5', 'twentytwenty'),
        'section'  => 'contact_information',
    )));
	
	// Footer Bottom Image 6
    $wp_customize->add_setting('footer_image_upload6', array(
        'default'           => '',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'footer_image_upload6', array(
        'label'    => __('Footer Bottom Logo 6', 'twentytwenty'),
        'section'  => 'contact_information',
    )));
